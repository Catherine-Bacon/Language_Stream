...
const DEFAULT_STREAMING_PRESET = {
    font_size: 1.0, 
    background_color: 'black', // MODIFIED: This is the desired SPAN color
...
function updateUIMode(mode, elements) {
    ...
    if (currentMasterMode === 'online') {
        ...
        if (elements.savedVideosHeader) {
            elements.savedVideosHeader.textContent = isYoutube 
...
document.addEventListener('DOMContentLoaded', async () => {
    const elements = {
        ...
        // --- NEW SAVED VIDEOS HEADER ---
        savedVideosHeader: document.getElementById('savedVideosHeader'), 
        // --- END NEW SAVED VIDEOS HEADER ---
