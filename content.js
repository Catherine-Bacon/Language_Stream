...
function startSubtitleSync(videoElement) {
    ...
    // <<< MODIFICATION START: Determine font weight based on style preference
    ...
    // <<< MODIFICATION START: Add font-weight to the base CSS
    const spanBaseCss = `
...
chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
    ...
    if (request.command === "fetch_and_process_url" && request.url) {
        ...
        subtitleStylePref = request.colourCoding; // <<< ADDED: Store the selected style
