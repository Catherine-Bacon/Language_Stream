...
(function() {
    ...
    // --- NEW FUNCTION: Loads and applies last used preferences on script injection ---
    async function initializePreferences() {
        ...
        const prefs = await chrome.storage.local.get(keysToLoad);
        
        // Load mode and style
        isTranslatedOnly = prefs.translated_only_pref || false;
        subtitleStylePref = prefs.subtitle_style_pref || 'netflix';
        
        // Load the specific style settings
        ...
        fontSizeEm = prefs[`${stylePrefix}font_size`] || defaults.font_size;
        backgroundColorPref = prefs[`${stylePrefix}background_color`] || defaults.background_color;
        backgroundAlphaPref = prefs[`${stylePrefix}background_alpha`] || defaults.background_alpha;
        fontShadowPref = prefs[`${stylePrefix}font_shadow`] || defaults.font_shadow;
        fontColorPref = prefs[`${stylePrefix}font_color`] || defaults.font_color;
        fontColorAlphaPref = prefs[`${stylePrefix}font_color_alpha`] || defaults.font_color_alpha;
